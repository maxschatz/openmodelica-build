...
# script can do is write a file to source -- and, on request, edit the rc file.
cat > "$ROOT/env.sh" <<EOF
# Generated by build.sh. Source this, or run build.sh --setup-shell.
